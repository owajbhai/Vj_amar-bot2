...
CLONE_DATABASE_URI = environ.get('CLONE_DATABASE_URI', "mongodb+srv://satreopalsen:jeHBB1FUJz6TS54k@cluster0.4yuohcu.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0") # Necessary If clone mode is true
