...
extra_channel = environ.get('EXTRA_CHANNEL', '-1002314687215') # give your force subscribe channel id here else leave it blank
EXTRA_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
