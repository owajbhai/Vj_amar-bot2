...
async def start(client, message):
    ...
    if AUTH_CHANNEL and not await is_subscribed(client, message):
        ...
        [[
            InlineKeyboardButton("⚡𝐉𝐨𝐢𝐧 𝐔𝐩𝐝𝐚𝐭𝐞 𝐂𝐡𝐚𝐧𝐧𝐞𝐥2⚡", url=invite_link.EXTRA_CHANNEL),
        ]]
        ...
        if vj and PREMIUM_AND_REFERAL_MODE == True:
            ...
            if PREMIUM_AND_REFERAL_MODE == True:
                ...
                buttons = [[
                    ...
                    InlineKeyboardButton('⍟ Aʙᴏᴜᴛ', callback_data='')
                ],[
                    InlineKeyboardButton('🌜𝐉𝐨𝐢𝐧 𝐔𝐩𝐝𝐚𝐭𝐞 𝐂𝐡𝐚𝐧𝐧𝐞𝐥🌛', url=CHNL_LNK)
                ]]
            reply_markup = InlineKeyboardMarkup(buttons)
            ...
            try:
                ...
                if STREAM_MODE == True:
                    button = [[
                        ...
                        InlineKeyboardButton('𝗕𝗢𝗧 𝗢𝗪𝗡𝗘𝗥', url="https://t.me/botmaster55")
                    ],[
        ...
        try:
            ...
            if STREAM_MODE == True:
                button = [[
                    ...
                    InlineKeyboardButton("𝗕𝗢𝗧 𝗢𝗪𝗡𝗘𝗥", url="t.me/botmaster55")
                ],[
                    InlineKeyboardButton('🚀 Fast Download / Watch Online🖥️', callback_data=f'generate_stream_link:{file_id}') #Don't change anything without contacting me @KingVJ01
                ]]
            else:
